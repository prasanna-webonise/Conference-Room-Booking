...
<body align="center">
	...
	<div class="maincontent">
		<div class="container">
			...
			<h2>The List of your bookings :</h2>


			<table class="tablecontent" align="center" border="1">
				<tr>
					<th>Event Id</th>
					<th>Date</th>
					<th>Start Time</th>
				...
				<c:forEach var="event" items="${employeeBookings}">
					<tr>
						<td>${event.eventId}</td>
						...
						<td>${event.endTime }</td>
						<td>${event.purpose }</td>
						<td>${event.room.roomId }</td>
						<td><a href="cancelBooking/${event.eventId}">CANCEL
								BOOKING</a></td>
					</tr>
				</c:forEach>
<tr>${message }</tr>
